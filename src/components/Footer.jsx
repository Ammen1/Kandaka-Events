...
export default function Footer() {
  return (
    <div className="flex w-auto flex-col font-sans ">
      <div className=" bg-[#0a1d42]  text-white shadow-2xl border-t-1 border-green-500 p-6">
        <div className="grid grid-cols-3 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4"> Kandaka Events</h3>
        ...
        <div className="flex justify-between items-center mt-6  border-t-2 border-white pt-4">
          <span>© 2024  Kandaka Events. All Rights Reserved</span>
